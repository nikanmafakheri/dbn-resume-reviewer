...
/**
 * Minimal inline SVG icon set (stroke-based, currentColor) so the
 * app needs no icon dependency. Add icons here as needed.
 */
...
const PATHS: Record<IconName, ReactNode_> = {
  upload: (
    <>
      <path d="M12 16V4" />
      <path d="m7 9 5-5 5 5" />
...
type ReactNode_ = import('react').ReactNode;
